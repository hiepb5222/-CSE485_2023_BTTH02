...
<body>
    ...
    <main class="container mt-5 mb-5">
        ...
        <div class="row">
            <div class="col-sm">
                ...
                <form action="./index.php?controller=member&action=add" method="post">
                    ...
                    <div class="form-group  float-end ">
                        ...
                        <a href="./index.php?controller=member&action=list" class="btn btn-warning ">Quay lại</a>
                    </div>
    ...
    <footer
        class="footer fixed-bottom bg-white d-flex justify-content-center align-items-center border-top border-secondary  border-2"
        style="height:80px">
